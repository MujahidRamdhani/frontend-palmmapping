...
const TambahPemetaan: React.FC = () => {
    ...
    const [lapisanPetaHutan, setLapisanPetaHutan] = useState<PolygonLayer[]>(
        [],
    );
                    ...
                    <div className="leaflet-container2">
                        ...
                        >
                            ...
                            {/* {lapisanPeta.map((layer, index) => (
                                <Polygon key={index} positions={layer.latlngs} color={layer.color} />
                            ))} */}
                            {lapisanPetaHutan.map((layer, index) => (
                                <Polygon
                                    key={index}
