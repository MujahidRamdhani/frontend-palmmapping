...
const koordinatAwal: LatLngLiteral[] = [
    { lat: 0.934454024134, lng: 115.199035644999 },
    { lat: 0.936487376891, lng: 115.212280273999 },
    { lat: 0.9294842482, lng: 115.231262207 },
    { lat: 0.92538983907, lng: 115.240714561999 },
    { lat: 0.951637088981, lng: 115.184020996 },
];
...
const TambahPemetaan: React.FC = () => {
    ...
    // console.log('koordinatAwal2:', koordinatAwal)
    ...
    //         { id: 1, latlngs: koordinatAwal, color: 'green', kawasan: 'hutan' },
    //     ]
    ...
    // console.log(state);
    // useEffect(() => {
    //     if (lapisanPeta.length > 0) {
    //         const hasil = tentukanWarnaPoligon(lapisanPeta[0].latlngs);
    //         console.log('Hasil:', hasil);
    //     }
    // }, [koordinatAwal, lapisanPeta]);
    useEffect(() => {
    ...
    const titikDalamPoligon = (
        ...
        console.log(`Point 1 (${x}, ${y}) within polygon: ${diDalam}`);
    ...
    const tentukanWarnaPoligon = (
        ...
        console.log('semuaTitikDiDalam', semuaTitikDiDalam);
