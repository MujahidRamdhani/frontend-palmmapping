...
const schema = z.object({
    nomorSTDB: z.string(),
    statusVerifikator: z.string(),
    pesanVerifikator: z.string(),
});
...
export default function TablePenerbitanSTDB() {
    ...
    const handleResetDiterima = () => {
        // reset({
        //     statusVerifikator: 'Diterima',
        //     // You can add other form fields here as needed
        // });

        setValue('statusVerifikator', 'Diterima');
    };
    ...
    return (
        <main>
            ...
            {combinedData
                .filter((stdb) => stdb.nomorSTDB === uuid) // Filters cooperatives with statusKonfirmasiKoperasi as "false" (string)
                .map((stdb, index) => (
