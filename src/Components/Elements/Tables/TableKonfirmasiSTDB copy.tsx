...
export default function PaginationTablePage() {
    ...
    let waktuStatusKonfirmasi = waktuSekarang;

    setValue('waktuStatusKonfirmasi', waktuStatusKonfirmasi);
        ...
        try {
            ...
            const response = await axios.patch(
                `http://localhost:5000/STDBS/${data.uuid}`,
                {
                    ...
                    waktuStatusKonfirmasi: data.waktuStatusKonfirmasi,
                },
            );
            ...
            console.log('Axios response hasil:', response.data);
        } catch (err) {
            console.log(err);
    ...
    if (user !== null) {
        ({ nik, nama } = user);
        setValue('nikKonfirmator', nik);
        setValue('namaKonfirmator', nama);
    }
                                                        ...
                                                        <div className="mt-4">
                                                            ...
                                                            <div className="ml-6">
                                                                ...
                                                                <h4 className="text-sm">
                                                                    ...
                                                                    &nbsp;
                                                                    <a
                                                                        href={`https://ipfs.io/ipfs/${stdb.cidFileLegalitasLahan}`}
                                                                    >
                                                                        Download
                                                                        PDF
                                                                    </a>
                                                        ...
                                                        {showModal && (
                                                            ...
                                                            >
                                                                <div className="hidden">
                                                                    ...
                                                                    />
                                                                    <InputDashboard
                                                                        label="waktuStatusKonfirmasi"
                                                                        id="waktuStatusKonfirmasi"
                                                                        type="string"
                                                                        register={
                                                                            register
                                                                        }
