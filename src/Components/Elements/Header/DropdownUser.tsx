...
const DropdownUser = () => {
    ...
    useEffect(() => {
        if (location.pathname === '/PalmMapping') {
            setHome(true);
        } else {
            setHome(false);
        }
        ...
        <div className="relative z-999">
            ...
            >
                <span className=" text-right lg:block">
                    <span
                        className={`block text-sm font-medium ${home ? 'text-white' : 'text-black'}  dark:text-white`}
                    >
                        {nama}
                    </span>
                    <span className="block text-xs">{roleState}</span>
                </span>
